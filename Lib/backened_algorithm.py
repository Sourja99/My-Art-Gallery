...
def add_color(file_path):                         
    net = cv2.dnn.readNetFromCaffe('.\\model\\colorization_deploy_v2.prototxt', '.\\model\\colorization_release_v2.caffemodel')  #open source deep learning framework by berkley vision and learning center
